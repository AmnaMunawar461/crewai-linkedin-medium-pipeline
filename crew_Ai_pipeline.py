...
llm = LLM(
    ...
    api_key="api-key" # Or set the environment variable
)
...
formatting_medium_blog = Task(
    ...
    # IMPORTANT: remove output_json / output_pydantic here
)
...
crew = Crew(
    ...
    verbose=False #Uncomment this to see the steps taken to get the final answer
)
